  ...
  'smtp_crypto' => 'ssl'
	...
	function _set_session($data)
	{
		...
		$user = array(						
			...
			'DX_logged_in'						=> TRUE,
			'DX_name'							=> $data->name,
			'DX_last_name'						=> $data->last_name,
			'DX_address'						=> $data->address,
			'DX_gender'							=> $data->gender,
			'DX_civil_status'					=> $data->civil_status,
			'DX_birth_date'						=> $data->birth_date,
			'DX_photo'							=> $data->photo,	
			'DX_instruction_level'				=> $data->instruction_level,
			'DX_observations'					=> $data->observations,
			'DX_blood_type'						=> $data->blood_type	
		);
