...
<title>Gestion de Evaluaciones</title>
	...
	<body>
		...
		<h4>Descripcion </h4>
		<input type="text" name="descripcion" value="<?php echo set_value('descripcion',$datos_evaluacion['descripcion'])?>" readonly="readonly" size="50" placeholder = "Taller grupal"/>
